    ...
    $.ajax({
        ...
        success: function (tiposProfesionMostrar) {
            ...
            $.each(tiposProfesionMostrar, function (index, tipoProfesion) {
                contenidoCard += `
                    <div class="profesion-group mb-4">
                ...
                $.each(tipoProfesion.listadoPersonas, function (index, persona) {
                    ...
                    <div class="col-md-4 col-sm-6 d-flex align-items-stretch card-container" id="card-${persona.servicioID}">
                        <div class="card mb-3" style="max-width: 540px; cursor: pointer;" onclick="cargarPerfil(${persona.servicioID})">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="https://mdbcdn.b-cdn.net/wp-content/uploads/2020/06/vertical.webp" alt="Profile Image" class="img-fluid rounded-start" />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">${persona.nombrePersona} ${persona.apellidoPersona}</h5>
                                        <p class="card-text"><strong>Teléfono:</strong> ${persona.telefonoPersona}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
