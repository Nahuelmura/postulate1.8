            ...
            $.each(tiposProfesionMostrar, function (index, tipoProfesion) {
                contenidoCard += `
                    <div class="profesion-group">
                        <h3 class="text-center texto-titulo-profesion">${tipoProfesion.nombre}</h3>
                        <div class="row justify-content-start">`;

                        $.each(tipoProfesion.listadoPersonas, function (index, persona) {
                            contenidoCard += `
                                <div class="col-md-6 col-lg-4 mb-3 d-flex align-items-stretch card-container card-hoover tamanio-card" id="card-${persona.trabajoID}">
